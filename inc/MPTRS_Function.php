	...
	if ( ! class_exists( 'MPTRS_Function' ) ) {
		class MPTRS_Function {
			...
			public static function week_day(): array {
				return [
					'monday'    => esc_html__( 'Monday', 'tablely' ),
					'tuesday'   => esc_html__( 'Tuesday', 'tablely' ),
					'wednesday' => esc_html__( 'Wednesday', 'tablely' ),
					'thursday'  => esc_html__( 'Thursday', 'tablely' ),
					'friday'    => esc_html__( 'Friday', 'tablely' ),
					'saturday'  => esc_html__( 'Saturday', 'tablely' ),
					'sunday'    => esc_html__( 'Sunday', 'tablely' ),
				];
			}
			...
			public static function get_name() {
				return self::get_general_settings( 'label', esc_html__( 'Tablely', 'tablely' ) );
			}
			...
			public static function get_category_label() {
				return self::get_general_settings( 'category_label', esc_html__( 'Category', 'tablely' ) );
			}
			...
			public static function get_organizer_label() {
				return self::get_general_settings( 'organizer_label', esc_html__( 'Organizer', 'tablely' ) );
			}
