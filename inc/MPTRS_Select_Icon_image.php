			...
			public function load_icon($name, $value = '') {
                ...
                <div class="mp_add_icon_area">
                    <button type="button" class="mp_add_icon dButton_xs ">
                        ...
                        <span class="<?php echo esc_html($value); ?>" data-empty-text="<?php esc_html_e('Add Icon', 'tablely'); ?>">
			                    <?php
				                    if (!$value) {
					                    esc_html_e('Add Icon', 'tablely');
				                    }
			                    ?>
			                </span>
                        <span class="fas fa-times remove_input_icon <?php echo esc_html($value ? 'active' : ''); ?> " title="<?php esc_html_e('Remove Icon', 'tablely'); ?>"></span>
                    </button>
                </div>
				<?php
                    ...
                    <div class="add_icon_popup mptrs_popup mptrs_area" data-popup="#add_icon_popup">
                        <div class="popupMainArea fullWidth">
                            <div class="popupHeader allCenter">
                                ...
                                <label class="min_300">
                                    <input type="text" class="formControl mp_name_validation" name="mp_select_icon_name" placeholder="<?php esc_attr_e('Icon/class name....', 'tablely'); ?>"/>
                                </label>
                                        ...
                                        <div class="dFlex">
                                            <ul class="popupIconMenu">
                                                <li class="active" data-icon-menu="all_item" data-icon-title="all_item">
													<?php esc_html_e('All Icon', 'tablely'); ?>&nbsp;(
			...
			public function add_single_image($name, $image_id = '') {
                ...
                <div class="add_single_image">
                    ...
                    <button type="button" class="_dButton_xs_bgColor_1_fullWidth <?php echo esc_attr($image_id ? 'dNone' : ''); ?>">
                        <span class="fas fa-images mR_xs"></span><?php esc_html_e('Image', 'tablely'); ?>
                    </button>
                </div>
				<?php
			}
			...
			public function add_icon_image($name, $icon = '', $image = '') {
                ...
                <div class="add_icon_image_area fdColumn">
                    ...
                    <div class="icon_item <?php echo esc_attr($icon_class); ?>">
                        ...
                        <span class="fas fa-times mp_remove_icon icon_remove" title="<?php esc_html_e('Remove Icon', 'tablely'); ?>"></span>
                    </div>
                    <div class="image_item <?php echo esc_attr($image_class); ?>">
	                    <?php echo wp_get_attachment_image($image, 'medium'); ?>
                        <span class="fas fa-times mp_remove_icon image_remove" title="<?php esc_html_e('Remove Image', 'tablely'); ?>"></span>
                    </div>
                    <div class="add_icon_image_button_area <?php echo esc_attr($button_active_class); ?>">
                        <div class="flexEqual d-flex flex-column">
                            <button class="_mpBtn_xs mp_image_add m-1" type="button">
                                <span class="fas fa-images"></span><?php esc_html_e('Image', 'tablely'); ?></button>
                            <button class="_mpBtn_xs icon_add m-1" type="button" data-target-popup="#add_icon_popup">
                                <span class="fas fa-plus"></span><?php esc_html_e('Icon', 'tablely'); ?></button>
                        </div>
                    </div>
                </div>
				<?php
