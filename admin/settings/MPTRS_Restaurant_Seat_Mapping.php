...
if ( ! class_exists('MPTRS_Restaurant_Seat_Mapping') ) {
    class MPTRS_Restaurant_Seat_Mapping
    {
        ...
        public function seat_mapping_tab_content() {
            ...
            $current_post_id = isset($_GET['post_id']) ? intval($_GET['post_id']) : '';
            $post_id = $current_post_id;
//            $post = get_post($post_id);


            error_log( print_r( [ '$current_post_id' => $current_post_id ], true ) );

            ?>

            <select id="pa_seat_mapping_select">
                <option value="">Select Restaurant</option>
                <option value="61">Restaurant 1</option>
                <option value="72">Restaurant 2</option>
            </select>
        ...
        public function render_meta_box( $post_id ) {
            ...
            */
            ...
            error_log( print_r( [ '$templates' => $templates ], true ) );
