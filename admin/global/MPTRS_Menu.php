            ...
            <div class="mptrs_order_page_wrap wrap">
                ...
                <table class="mptrs_order_page_table">
                    ...
                    if ($query->have_posts()) :
                        ...
                        ?>
                        <tr>
                            <td colspan="10"><?php esc_html_e( 'No orders found.', 'tablely' ); ?></td>
                        </tr>
                    <?php
                    endif;
                    ?>
...
//                            $status              = ( $order && $order->get_status() === 'trash')? $order->get_status() : get_post_meta( $post_id, '_mptrs_order_status', true );
                                ...
                                <script>
                                    ...
                                    document.querySelectorAll('.pro-overlay').forEach(function (button) {
                                        button.addEventListener('click', function (event) {
                                            ...
                                            window.open('<?php echo esc_js( esc_url( 'https://mage-people.com/product/tablely/' ) ); ?>', '_blank');
                                        });
                                    });
                                </script>
                                <?php
                    ...
                    <?php endwhile; else : ?>
                        <tr>
                            <td colspan="12"><?php esc_html_e( 'Sorry, No data found!', 'tablely' ); ?></td>
                        </tr>
                    <?php endif;
                    wp_reset_postdata(); ?>
                    </tbody>
